  ...
  return (
    <section className="bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-6">
        {/* Judul */}
        <h2 className="text-3xl md:text-4xl  mb-8" data-aos="fade-right">
          Identitas <span className="font-bold ">Sekolah</span>
        </h2>

        <div className="bg-white shadow-lg p-6 md:p-10" data-aos="fade-up">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>
                  <strong>Prog. Keahlian T. Komputer & Informatika:</strong> 92
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>
                  <strong>No SK Pengangkatan:</strong> 821.2/Kepeg.373.BKD/2020
                </li>
                <li>
