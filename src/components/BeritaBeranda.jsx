  ...
  return (
    <section className="py-20">
      ...
      <div class="flex justify-center mt-8">
        <Link to={"/berita"} className="px-4 py-2 border-[#0265af] border text-[#0265af] hover:bg-[#0265af] hover:text-white transition font-[Satoshi] rounded-md text-sm font-semibold">Lihat Semua</Link>
      </div>
    </section>
  );
};
